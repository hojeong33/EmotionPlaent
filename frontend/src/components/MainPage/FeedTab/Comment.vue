<template>
  <div>
    ...
    <!-- <div style="position: absolute;"> -->
      <img id="comment_img" :src="commentData.userRequestDto.profileImg" alt=""> <span style="font-weight:bold; font-size:1.2rem;">{{commentData.userRequestDto.nickname}} </span>
      <span style="font-size:1.2rem">{{commentData.descr}} </span>
    </div>
