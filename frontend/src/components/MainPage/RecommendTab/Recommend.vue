    ...
    <div>
        <div id="container">
          ...
          <div id="header">
            ...
            <span id="planet_name" :style="{color:tmp.color}">{{tmp.name }}</span>
            <span style="font-size:2.5rem;" >입니다</span>
          </div>
        </div>
    </div>
    <div class="tab">
      <p @click="Refresh" :class="onRefresh ? 'active': 'inactive'">&nbsp;&nbsp;&nbsp;기분 전환 </p>
      <p @click="Feel" :class="onFeel ? 'active': 'inactive'">기분 즐기기</p>
    </div>
