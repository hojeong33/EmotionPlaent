  ...
  <div id="pu_container">
    ...
    <section id="pu_body">
      <article id="profile_head">
        <img
          id="profile_img"
          src="../../assets/images/KakaoTalk_20220112_170830193.jpg"
          alt=""
        />
        <p id="user_id">유저 아이디</p>
        <div id="profile_img_change">
          <button id="profile_img_change_button" @click="profileImgChangeModal">
            사진 변경
          </button>
        </div>
      </article>
      ...
      <article id="pu_form">
        ...
        <input id="nickname" placeholder="나는멋쟁이" />
      </article>
      <br />
      <article id="pu_form">
        <p id="introduce">소개</p>
        <textarea id="short_comment" placeholder="나는야 멋쟁이~"></textarea>
      </article>
      <br />
      <article id="pu_form">
...
export default {
  ...
  methods: {
    pwCheck: function () {
      if (
        this.credentials.nextPw &&
        this.credentials.nextPw.length >= 8 &&
        this.credentials.nextPw.length <= 20
      ) {
    ...
    pwConfCheck: function () {
      if (
        this.credentials.pwConf &&
        this.credentials.nextPw === this.credentials.pwConf
      ) {
